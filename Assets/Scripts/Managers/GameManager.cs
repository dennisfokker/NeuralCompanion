...
public class GameManager : MonoBehaviour
{
    ...
    void Start ()
	{
        ...
        PlayerFighterController = Instantiate(PlayerFighterPrefab, PlayerStartPosition, Quaternion.identity).GetComponent<FighterController>();
        OpponentFighterController = Instantiate(OpponentFighterPrefab, OpponentStartPosition, Quaternion.identity).GetComponent<FighterController>();
    }
}
